...
def parse_args():
    ...
    parser.add_argument('--model_type', default='PFLD_GhostNet', type=str)
    ...
    parser.add_argument('--model_path', default="./pfld_ghostnet_best200.pth", type=str)
    parser.add_argument('--test_dataset', default='./data/min/test_data/list.txt', type=str)
